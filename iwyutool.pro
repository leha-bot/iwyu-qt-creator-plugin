...
isEmpty(IDE_SOURCE_TREE): IDE_SOURCE_TREE = "D:/Projects/opensource/qt-creator"

## Either set the IDE_BUILD_TREE when running qmake,
## or set the QTC_BUILD environment variable, to override the default setting
isEmpty(IDE_BUILD_TREE): IDE_BUILD_TREE = $$(QTC_BUILD)
isEmpty(IDE_BUILD_TREE): IDE_BUILD_TREE = "D:/Projects/opensource/build-qtcreator-Desktop_Qt_5_12_4_MSVC2017_32bit-Debug"
